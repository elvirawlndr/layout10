      ...
      body: Padding(
        ...
        child: Column(
          children: [
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text("1301210499 - Elvira Wulandari", style: TextStyle(
                        fontSize: 14,
            ...
            const Text('Riwayat Tes', style: TextStyle(
              color: Colors.black,
              fontSize: 28,
              fontWeight: FontWeight.w700,
              letterSpacing: 0.25)),
            ...
            ElevatedButton(
              ...
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => const Tutorial12()),
                );
              },
            )
          ],
